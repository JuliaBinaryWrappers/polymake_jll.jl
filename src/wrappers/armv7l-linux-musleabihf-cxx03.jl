...
JLLWrappers.@declare_library_product(libpolymake, "libpolymake.so.4.15")
JLLWrappers.@declare_library_product(libpolymake_apps_rt, "libpolymake-apps-rt.so.4.15")
