...
const libpolymake_apps_rt_splitpath = ["lib", "libpolymake-apps-rt.so"]
...
# This must be `const` so that we can use it with `ccall()`
const libpolymake_apps_rt = "libpolymake-apps-rt.so.4.1"
...
function __init__()
    ...
    foreach(p -> append!(LIBPATH_list, p), (CompilerSupportLibraries_jll.LIBPATH_list, FLINT_jll.LIBPATH_list, GMP_jll.LIBPATH_list, MPFR_jll.LIBPATH_list, PPL_jll.LIBPATH_list, Perl_jll.LIBPATH_list, bliss_jll.LIBPATH_list, boost_jll.LIBPATH_list, cddlib_jll.LIBPATH_list, lrslib_jll.LIBPATH_list, normaliz_jll.LIBPATH_list,))
