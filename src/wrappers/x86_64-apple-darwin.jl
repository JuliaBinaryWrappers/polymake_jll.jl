...
JLLWrappers.@declare_library_product(libpolymake, "@rpath/libpolymake.4.15.dylib")
JLLWrappers.@declare_library_product(libpolymake_apps_rt, "@rpath/libpolymake-apps-rt.4.15.dylib")
...
function __init__()
    ...
    JLLWrappers.@init_library_product(
        libpolymake,
        "lib/libpolymake.4.15.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libpolymake_apps_rt,
        "lib/libpolymake-apps-rt.4.15.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
